...
The first PC then points in the direction with the largest variance, the second PC points in the direction orthogonal to PC1 with the largest variance, etc. The proportion of variance explained by a single PC can be computed using the eigenvalues: 
